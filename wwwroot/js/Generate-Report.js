        ...
        async function createPdf() {
            ...
            function wrapText(text, font, fontSize, maxWidth) {
             ...
             function drawTextWithWrap(page, text, x, y, font, fontSize, maxWidth, lineHeight) {
                ...
                //const currentFont = isBold ? boldFont : font;  //in bold
            ...
            function drawTextWithWrapHd(page, text, x, y, font, fontSize, maxWidth, lineHeight, isBold = false) {
                const lines = wrapText(text, font, fontSize, maxWidth);
                ...
                lines.forEach(line => {
                    ...
                    page.drawText(line, { x, y: currentYPosition, size: fontSize, font: currentFont });
                    currentYPosition -= lineHeight;
                });
                return currentYPosition;
            }
            ...
            // Draw Handover section
             drawSection('Handover', () => {
                currentYPosition = drawTextWithWrapHd(page, `Patient's First Name:`, margin + padding, currentYPosition, timesRomanFont, fontSizeField, maxWidth, 15,true);
               ...
               /*  currentYPosition = drawTextWithWrap(page, `Patient's First Name: ${handoverData.firstName || ''}`, margin + padding, currentYPosition, timesRomanFont, fontSizeField, maxWidth, 15,true);
                currentYPosition = drawTextWithWrap(page, `Patient's Last Name: ${handoverData.lastName || ''}`, margin + padding, currentYPosition, timesRomanFont, fontSizeField, maxWidth, 15,true);
                currentYPosition = drawTextWithWrap(page, `Age: ${handoverData.age || ''}`, margin + padding, currentYPosition, timesRomanFont, fontSizeField, maxWidth, 15,true);
                currentYPosition = drawTextWithWrap(page, `Date of Birth: ${handoverData.dateOfBirth || ''}`, margin + padding, currentYPosition, timesRomanFont, fontSizeField, maxWidth, 15,true);
                currentYPosition = drawTextWithWrap(page, `Mechanism/Complaints: ${handoverData.complaints || ''}`, margin + padding, currentYPosition, timesRomanFont, fontSizeField, maxWidth, 15,true);

                currentYPosition = drawTextWithWrap(page, `Injuries/Information About Complaint:`, margin + padding, currentYPosition, timesRomanFont, fontSizeField, maxWidth, 15,true);
                ...
                currentYPosition = drawTextWithWrap(page, `Pulse Rate: ${signsData.pulserate}`, margin + padding, currentYPosition, timesRomanFont, fontSizeField, maxWidth, 15, true);
                currentYPosition = drawTextWithWrap(page, `Blood Pressure: ${signsData.bloodpressure}`, margin + padding, currentYPosition, timesRomanFont, fontSizeField, maxWidth, 15,true);
                currentYPosition = drawTextWithWrap(page, `Pupillary Response: ${signsData.pupillaryresponse}`, margin + padding, currentYPosition, timesRomanFont, fontSizeField, maxWidth, 15,true);
                currentYPosition = drawTextWithWrap(page, `Temperature: ${signsData.temperature}`, margin + padding, currentYPosition, timesRomanFont, fontSizeField, maxWidth, 15,true);
                currentYPosition = drawTextWithWrap(page, `GCS Total: ${signsData.gcstotal}`, margin + padding, currentYPosition, timesRomanFont, fontSizeField, maxWidth, 15,true);
